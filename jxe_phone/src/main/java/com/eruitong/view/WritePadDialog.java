...
public class WritePadDialog extends Dialog {
	...
	public WritePadDialog(Context context, DialogListener dialogListener, int screenW, int screenH) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		p.height = screenH / 10 * 8;// (int) (d.getHeight() * 0.4); //高度设置为屏幕的0.4
		p.width = screenW ;// (int) (d.getWidth() * 0.6); //宽度设置为屏幕的0.6
