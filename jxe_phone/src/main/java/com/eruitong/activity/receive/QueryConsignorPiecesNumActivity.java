...
import com.eruitong.activity.receive.QueryConsignorPiecesNumActivity.LstOrderAdapter.I_QueryNumber;
 ...
 */
public class QueryConsignorPiecesNumActivity extends BaseActivity implements Hearer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consignorpieces_number);
    ...
    private void initComps() {
        ...
        mstartDate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                @SuppressLint("WrongConstant") Dialog dialog = new DatePickerDialog(QueryConsignorPiecesNumActivity
    ...
    private void query() {
        ...
        httpUtils.send(HttpMethod.POST, MyApp.mPathServerURL + Conf.queryConsignorPiecesNum, params, new
    ...
    class LstOrderAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewgroup) {
            ...
            if (view == null) {
                ...
                view = getLayoutInflater().inflate(R.layout.item_consign_waybill_number, null);

                holder.empcode = (TextView) view.findViewById(R.id.item_txt_consignor_waybillnum_code);
                holder.pollCount = (TextView) view.findViewById(R.id.item_txt_consignor_waybillnum_piaonum);
                holder.quantity = (TextView) view.findViewById(R.id.item_txt_consignor_waybillnum_quantityynum);
                holder.expressFee = (TextView) view.findViewById(R.id.item_txt_consignor_waybillnum_expressFee);
                view.setTag(holder);
            } else {
